...
//                    y = mRawData.raw.readFloat();
					...
					ApplicationDomain.currentDomain.domainMemory = mRawData.raw;
					x = lf32(sourcePos);
					y = lf32(sourcePos + 4);

					ApplicationDomain.currentDomain.domainMemory = targetRawData.raw;
...
//                        y = mRawData.raw.readFloat();
        ...
        {
			var pos :uint = mRawData.rawOffset;
