    ...
    public class Starling extends EventDispatcher
    {
        ...
        private function onTouch(event:Event):void
        {
            ...
            switch (event.type)
            {
				...
				case "rightMouseDown":       phase = TouchPhase.RIGHT_BEGAN; break;
                case "rightMouseUp":         phase = TouchPhase.RIGHT_ENDED; break;
        ...
        private function get touchEventTypes():Array
        {
            ...
            if (!multitouchEnabled || Mouse.supportsCursor)
                types.push(MouseEvent.MOUSE_DOWN,  MouseEvent.MOUSE_MOVE, MouseEvent.MOUSE_UP, "rightMouseDown", "rightMouseUp");
