...
package tests.utils
{
    ...
    public class AssetManagerAirTest extends StarlingTestCase
    {
        private const FIXTURES_PATH_PREFIX:String = "";
        private const TEST_UNICODE_PATHCOMPONENT:String = "\u30C6\u30B9\u30C8"; // "Test" in Japanese Katakana
        ...
        {
            manager.enqueue(FIXTURES_PATH_PREFIX + "image.png");
            manager.loadQueue(AsyncUtil.asyncHandler(this, function(ratio:Number):void
            {
        ...
        {
            manager.enqueue(FIXTURES_PATH_PREFIX + "image.jpg");
            manager.loadQueue(AsyncUtil.asyncHandler(this, function(ratio:Number):void
            {
                assertEquals(1, manager.getTextures("image").length);
            }));
        ...
        {
            manager.enqueue(FIXTURES_PATH_PREFIX + "image.gif");
            manager.loadQueue(AsyncUtil.asyncHandler(this, function(ratio:Number):void
            {
                assertEquals(1, manager.getTextures("image").length);
            }));
        ...
        {
            manager.enqueue(FIXTURES_PATH_PREFIX + "xml.xml");
            manager.loadQueue(AsyncUtil.asyncHandler(this, function(ratio:Number):void
            {
        ...
        public function loadInvalidXmlFromFile():void
        {
            ...
            manager.enqueue(FIXTURES_PATH_PREFIX + "invalid.xml");
        ...
        {
            manager.enqueue(FIXTURES_PATH_PREFIX + "json.json");
            manager.loadQueue(AsyncUtil.asyncHandler(this, function(ratio:Number):void
            {
        ...
        {
            handleStarlingEvent(Event.PARSE_ERROR, manager);
            manager.enqueue(FIXTURES_PATH_PREFIX + "invalid.json");
            manager.loadQueue(function(ratio:Number):void { });
        }
        ...
        {
            manager.enqueue(FIXTURES_PATH_PREFIX + "audio.mp3");
            manager.loadQueue(AsyncUtil.asyncHandler(this, function(ratio:Number):void
            {
        ...
        {
            manager.enqueue(FIXTURES_PATH_PREFIX + "atlas.xml");
            manager.loadQueue(AsyncUtil.asyncHandler(this, function(ratio:Number):void
            {
        ...
        {
            manager.enqueue(FIXTURES_PATH_PREFIX + "font.xml");
            manager.loadQueue(AsyncUtil.asyncHandler(this, function(ratio:Number):void
            {
        ...
        {
            manager.enqueue(FIXTURES_PATH_PREFIX + "data.txt");
            manager.loadQueue(AsyncUtil.asyncHandler(this, function(ratio:Number):void
            {
        ...
        {
            manager.enqueue(FIXTURES_PATH_PREFIX + "atf.atf");
            manager.loadQueue(AsyncUtil.asyncHandler(this, function(ratio:Number):void
            {
        ...
        [Test(async)]
        public function loadBitmapFromPngFileObject():void
        {
            var file:File = File.applicationDirectory.resolvePath(FIXTURES_PATH_PREFIX + "image.png");
...
{
    [Embed(source="../../../embeddedFixtures/image.png")]
    public static const Image:Class;
}

class EmbeddedXml
{
    [Embed(source="../../../embeddedFixtures/xml.xml", mimeType="application/octet-stream")]
    public static const Data:Class;
}

class EmbeddedJson
{
    [Embed(source="../../../embeddedFixtures/json.json", mimeType="application/octet-stream")]
    public static const Data:Class;
}
